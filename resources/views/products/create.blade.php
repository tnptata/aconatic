        ...
        <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="md:col-span-1">
                    ...
                    <input type="number" name="amount" placeholder="Amount" autocomplete="off"  class="transition-all flex items-center h-10 border mt-1 rounded px-4 w-full bg-gray-50 @error('detail') border-red-400 @enderror" placeholder="Amount" value="{{ old('amount') }}" />
                    @error('amount')
                    <div class="text-red-600">
                        {{ $message }}
                    </div>
