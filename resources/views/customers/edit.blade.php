...
<form action="{{ route('customers.update',['customer' => $customer->id]) }}" method="POST" enctype="multipart/form-data">
    ...
    <div class="container max-w-screen-lg mx-auto">
        <div>
        <h2 class="font-semibold text-xl text-gray-600">Edit customers</h2>
        ...
        <div class="bg-white rounded shadow-lg p-4 px-4 md:p-8 mb-6">
            ...
            <div class="lg:col-span-2">
                ...
                <div class="md:col-span-5">
                    ...
                    <input type="text" name="name" id="name" class="h-10 border mt-1 rounded px-4 w-full bg-gray-50 @error('name') border-red-400 @enderror"
